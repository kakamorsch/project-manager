...
const ActivityItem = ({ activity }) => {
  ...
  return (
    <div className="mb-4 p-4 border rounded-lg shadow-sm">
      ...
      <div className={activity.completed ? 'flex justify-between mt-2 text-sm text-gray-500' : 'flex justify-between mt-2 text-sm bg-green-100 text-green-800'}>
    ...
    >
      ...
      >
        ...
        <header className="mb-6">
          <h1 id="modalTitle" className="text-3xl font-bold">{project.name}</h1>
